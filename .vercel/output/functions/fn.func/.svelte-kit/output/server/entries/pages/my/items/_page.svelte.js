...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  return `<h2 class="text-3xl font-bold">My Items${validate_component(Icon, "Icon").$$render(
    $$result,
    {
...
<div class="w-full mt-4 flex flex-col items-center">${data.items.length === 0 ? `<p class="text-center text-3xl">😮</p>
		<p class="text-center text-3xl m-3">Looks like you don&#39;t have any products in your notebook.</p>
